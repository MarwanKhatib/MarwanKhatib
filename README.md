...
<table width="100%">
  ...
  <tr>
    <td>- Blue</td>
    <td>- Brim</td>
    <td>- Burp Suite: Extensions</td>
  </tr>
  <tr>
    <td>- Burp Suite: Intruder</td>
    <td>- Burp Suite: Other Modules</td>
    <td>- Burp Suite: Repeater</td>
  </tr>
  <tr>
    <td>- Burp Suite: The Basics</td>
    <td>- CORS & SOP</td>
    <td>- CSRF</td>
  </tr>
  <tr>
    <td>- Careers in Cyber</td>
    <td>- Command Injection</td>
    <td>- Content Discovery</td>
  </tr>
  <tr>
    <td>- Core Windows Processes</td>
    <td>- Custom Alert Rules in Wazuh</td>
    <td>- Custom Tooling Using Python</td>
  </tr>
  <tr>
    <td>- Cyber Kill Chain</td>
    <td>- DFIR: An Introduction</td>
    <td>- DNS in Detail</td>
  </tr>
  <tr>
    <td>- DOM-Based Attacks</td>
    <td>- Defensive Security Intro</td>
    <td>- Diamond Model</td>
  </tr>
  <tr>
    <td>- Enumeration & Brute Force</td>
    <td>- Eviction</td>
    <td>- Exploit Vulnerabilities</td>
  </tr>
  <tr>
    <td>- File Inclusion</td>
    <td>- File Inclusion, Path Traversal</td>
    <td>- Game Zone</td>
  </tr>
  <tr>
    <td>- HTTP Browser Desync</td>
    <td>- HTTP Request Smuggling</td>
    <td>- HTTP in Detail</td>
  </tr>
  <tr>
    <td>- HTTP/2 Request Smuggling</td>
    <td>- HackPark</td>
  ...
  <tr>
    <td>- IDOR</td>
    <td>- Ice</td>
    <td>- Incident handling with Splunk</td>
  </tr>
  <tr>
    <td>- Insecure Deserialisation</td>
    <td>- Intro to Cross-site Scripting</td>
    <td>- Intro to Cyber Threat Intel</td>
  </tr>
  <tr>
    <td>- Intro to Endpoint Security</td>
    <td>- Intro to LAN</td>
    <td>- Intro to SSRF</td>
  </tr>
  <tr>
    <td>- Introduction to DevSecOps</td>
    <td>- Introduction to SIEM</td>
    <td>- Introductory Networking</td>
  </tr>
  <tr>
    <td>- Investigating with ELK 101</td>
    <td>- JWT Security</td>
    <td>- Junior Security Analyst Intro</td>
  </tr>
  <tr>
    <td>- Kenobi</td>
    <td>- LDAP Injection</td>
    <td>- Linux Fundamentals Part 1</td>
  </tr>
  <tr>
    <td>- Linux Fundamentals Part 2</td>
    <td>- Linux Fundamentals Part 3</td>
    <td>- Linux Privilege Escalation</td>
  </tr>
  <tr>
    <td>- MISP</td>
    <td>- MITRE</td>
    <td>- Metasploit: Exploitation</td>
  </tr>
  <tr>
    <td>- Metasploit: Introduction</td>
    <td>- Metasploit: Meterpreter</td>
    <td>- Multi-Factor Authentication</td>
  </tr>
  <tr>
    <td>- NetworkMiner</td>
    <td>- Nmap Advanced Port Scans</td>
    <td>- Nmap Basic Port Scans</td>
  </tr>
  <tr>
    <td>- Nmap Live Host Discovery</td>
    <td>- Nmap Post Port Scans</td>
    <td>- NoSQL Injection</td>
  </tr>
  <tr>
    <td>- OAuth Vulnerabilities</td>
    <td>- ORM Injection</td>
    <td>- OWASP Juice Shop</td>
  </tr>
  <tr>
    <td>- OWASP Top 10 - 2021</td>
    <td>- Offensive Security Intro</td>
    <td>- OpenCTI</td>
  </tr>
  <tr>
    <td>- OpenVPN</td>
    <td>- Osquery: The Basics</td>
    <td>- Passive Reconnaissance</td>
  </tr>
  <tr>
    <td>- Pentesting Fundamentals</td>
    <td>- Principles of Security</td>
    <td>- Protocols and Servers</td>
  </tr>
  <tr>
    <td>- Protocols and Servers 2</td>
  ...
  <tr>
    ...
    <td>- Request Smuggling: WebSockets</td>
  </tr>
  <tr>
    <td>- Retracted</td>
    <td>- SQL Injection</td>
  ...
  <tr>
    <td>- TShark: CLI Wireshark Features</td>
    <td>- TShark: The Basics</td>
    <td>- Threat Intelligence Tools</td>
  </tr>
  <tr>
    <td>- Traffic Analysis Essentials</td>
    <td>- Trooper</td>
    <td>- Unified Kill Chain</td>
  </tr>
  <tr>
    <td>- Upload Vulnerabilities</td>
    <td>- Vulnerabilities 101</td>
    <td>- Vulnversity</td>
  </tr>
  <tr>
    <td>- Walking An Application</td>
    <td>- Wazuh</td>
    <td>- What is Networking?</td>
  </tr>
  <tr>
    <td>- What the Shell?</td>
    <td>- Windows Event Logs</td>
    <td>- Windows Forensics 1</td>
  </tr>
  <tr>
    <td>- Windows Forensics 2</td>
    <td>- Windows Privilege Escalation</td>
    <td>- Wireshark: Packet Operations</td>
  </tr>
  <tr>
    <td>- Wireshark: The Basics</td>
    <td>- Wireshark: Traffic Analysis</td>
    <td>- XSS</td>
  </tr>
  <tr>
    <td>- XXE Injection</td>
...
<table width="100%">
  ...
  <tr>
    <td>- Injectics</td>
    <td>- Investigating with Splunk</td>
    <td>- ItsyBitsy</td>
  </tr>
  <tr>
    <td>- Monday Monitor</td>
    <td>- Mr Robot CTF</td>
  ...
  <tr>
    <td>- Snort Challenge - Live Attacks</td>
    <td>- Snort Challenge - The Basics</td>
    <td>- Summit</td>
  </tr>
  <tr>
    <td>- TShark Challenge I: Teamwork</td>
    <td>- TShark Challenge II: Directory</td>
    <td>- TryHack3M: Bricks Heist</td>
  </tr>
  <tr>
    <td>- Vulnerability Capstone</td>
    <td>- Whats Your Name?</td>
    <td>- Zeek Exercises</td>
  </tr>
</table>
</details>
...
-   **Offensive Security:**
    ...
    -   **Red Teaming:** Phishing, C2 Frameworks, Evasion Techniques.
-   **Defensive Security:**
    -   **Secure Coding:** Input Validation, Authentication/Authorization, Secure SDLC.
    -   **Monitoring:** SIEM (Splunk, Wazuh), Log Analysis, Incident Response.
...
#### **Full-Stack Developer** | Annecto Telecom | *2023 – Present*
